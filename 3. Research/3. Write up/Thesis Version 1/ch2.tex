...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		...
		\begin{tabular}{|l|>{\centering\arraybackslash}m{3cm}|>{\raggedright\arraybackslash}m{5cm}|l|}
			...
			\hline
			\multirow{3}{*}{WIIB}& \multirow{3}{*}{3} & Raspberry Pi Zero & Data Processing \\ \cline{3-4} & & Arduino Mega 2560 & Y\\ \cline{3-4} && Raspberry Pi Zero & Wave processing \\
			\hline
			\multirow{2}{*}{WIIOS} & \multirow{2}{*}{2} & Intel Edison dual core & Wave processing \\ \cline{3-4}&& ATMega 328 & Low power unit \\
			\hline
			...
			\hline
			Polar ISVP & 1 & Global Platform Transceiver Controller (GPTII)\footnotemark & Data processing and control \\
			\hline
...
\footnote[1]{Developed by \textcite{uptempo}$^{\text{TM}}$}
