...
\begin{center}{\setlength{\extrarowheight}{5pt}%
		\begin{longtable}[H]{>{\RaggedRight}m{0.4\textwidth}>{\RaggedRight}m{0.2\textwidth} >{\RaggedRight}m{0.4\textwidth}}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lccccc}
			...
			\hline
			Price &	R2,526\footnotemark[3] & 2,526\footnotemark[4] & R23,317\footnotemark[5]& R13,123\footnotemark[6] & R5,638\footnotemark[7]\\
			\hline
			\hline
	\end{tabular}}
\end{table}
\footnotetext[1]{GBP 1 = ZAR 20.41; USD 1 = ZAR 15.1}
...
\begin{table}[H]
	...
	\end{tabular}
\end{table}
\footnotetext[2]{USD 1 = ZAR 15.1}
\footnotetext[3]{GBP 1 = ZAR 20.41 }
