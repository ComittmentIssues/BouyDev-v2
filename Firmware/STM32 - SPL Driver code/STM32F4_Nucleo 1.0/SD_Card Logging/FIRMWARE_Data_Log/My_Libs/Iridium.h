...
#define Iridium_GPIO_RCCPeriph RCC_AHB1Periph_GPIOC
...
#define Iridium_USART UART5
#define Iridium_GPIO GPIOC
/*
...
#define DMA_USART_RX_IRQn	DMA1_Stream0_IRQn
#define DMA_USART_MEM_IRQn	DMA2_Stream1_IRQn
#define DMA_USART_RX_IRQHandler DMA1_Stream0_IRQHandler
#define DMA_USART_MEM_IRQHandler DMA2_Stream1_IRQHandler

#define Iridium_NetAv_Pin GPIO_Pin_13
#define Iridium_Wakeup_Pin GPIO_Pin_15
#define Iridium_USART_TX GPIO_Pin_12

#define Iridium_USART_RX GPIO_Pin_2 //on Port D

#define Iridium_USART_TXsrc GPIO_PinSource12
#define Iridium_USART_RXsrc GPIO_PinSource2
#define Iridium_Wakeup_Pinsrc GPIO_PinSource15
#define Iridium_NetAv_Pinsrc GPIO_PinSource13

#define NetAv_EXTI_Line EXTI_Line13
#define NetAv_EXTI_IRQn EXTI1_IRQn
...
#define Iridium_GPIO_AF GPIO_AF_UART5
#define Iridium_USART_IRQHandler UART5_IRQHandler
#define Iridium_USART_IRQn UART5_IRQn
