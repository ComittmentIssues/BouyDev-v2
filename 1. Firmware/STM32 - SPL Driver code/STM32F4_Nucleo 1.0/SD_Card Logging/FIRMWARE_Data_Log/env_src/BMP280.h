...
#include "stm32f4xx.h"
/*
 * BMP280_trim_t: A struct to hold the trimming parameters for
 * calaculating temperature and pressure
 * Note: These values allow for temperature and pressure compensation
 */
typedef struct{
	uint16_t 	dig_T1;
	int16_t 	dig_T2;
...
/*
 * BMP280_data_t is a compact struct for storing environmental
 * data. Note if you preffer to store in variables, you can leave
 * this struct out.
 */
typedef struct
{
