...
#define Delay_Timer TIM5
#define RCC_DelayPeriphClockCmd RCC_APB1PeriphClockCmd
#define RCC_Delay_Periph RCC_APB1Periph_TIM5
#define Delay_IRQHandler TIM5_IRQHandler
#define Delay_IRQn  TIM5_IRQn
#define clock_frequency 24000000 //APB1 (Sysclock/2)
#define PSC_Base 23999
